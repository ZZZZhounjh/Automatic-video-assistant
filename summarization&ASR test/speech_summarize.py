...
prompt_template = """
              Act as a professional speech summary writer. Write a summary of the following text delimited by triple backticks.
...
refine_template = (
        "Your job is to produce a final summary for the speech\n"
...
### save output text
output_file_path = "speech_summary.txt"
