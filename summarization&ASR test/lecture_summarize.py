...
prompt_template = """
              Act as a professional lecture summary writer. Write a summary of the following lecture text delimited by triple backticks.
              Return the key points of the text.
              Format: Lecture summary
              Introduction:<
              -Briefly introduce the lecture topic and the speaker
              -Mention the main objectives or themes of the lecture>
              Key Points:<
              -List the main points or arguments presented by the speaker
              -Provide a brief explanation or example for each key point>
              Conclusion:<
  -           -Summarize the main findings or conclusions of the lecture
              -Highlight the overall importance or implications of the lecture topic>
